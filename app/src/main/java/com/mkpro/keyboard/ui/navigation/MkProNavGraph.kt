...
import com.mkpro.keyboard.ui.screens.settings.SettingsScreen
 ...
 */
@Composable
fun MkProNavGraph(navController: NavHostController, startDestination: String = Screen.Splash.route) {
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        composable(Screen.Home.route) {
            HomeScreen(
                onOpenPcConnectionMode = { navController.navigate(Screen.Connection.route) },
        ...
        composable(Screen.Keyboard.route) {
            KeyboardScreen(onOpenSettings = { navController.navigate(Screen.Settings.route) })
        }
